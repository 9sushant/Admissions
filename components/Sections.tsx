                ...
                <div className="lg:col-span-1">
                 ...
                 <div className="lg:col-span-1">
                    ...
                    <div className="space-y-2">
                        ...
                        <a href="tel:+916307930834" className="flex items-center justify-center sm:justify-start gap-2 hover:text-white transition">
                            <PhoneIcon className="w-5 h-5"/> +91 63079 30834
                        </a>
                    </div>
                </div>
                 <div className="lg:col-span-1">
