...
section                 <p className="text-gray-300">{item.outcome}</p>
                    </div>
                ))}
            </div>
        </Section>
...
    A       <div className="space-y-4 text-lg text-gray-300">
                <p>CBSE Curriculum</p>
...
A       <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-1 md:gap-y-16">
          {steps.map((step, index) => (
            <div key={index} className="relative flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 md:pr-8 flex md:justify-end">
                 {index % 2 === 0 && (
                   <div className="text-left md:text-right w-full">
source                <h3 className="text-2xl font-bold text-blue-400">{step.title}</h3>
                   </div>
                 )}
              </div>
...
                </div>
            </div>
  A         <div className="mt-8 border-t border-gray-800 pt-6 text-center text-sm">
...
            >
          _       Apply for Admissions 2025–26
                </button>
        </div>
    );
};
